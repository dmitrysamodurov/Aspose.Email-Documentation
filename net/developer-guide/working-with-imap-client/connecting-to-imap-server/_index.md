...
The code example below shows you how to set TLS 1.3 for [ImapClient](https://apireference.aspose.com/email/net/aspose.email.clients.imap/imapclient) class instance.
